...
- [x] **5. Onboarding wizard + TDEE calculation + initial plan generation**
...
- [x] **6. Quick Log tab — text, photo, screenshot + Claude categorization**
...
- [x] **7. Training Plan tab — plan display + frequency note + injury warnings + swap/edit**
...
- [x] **8. Nutrition tab — macro targets panel + empty/logged states**
...
- [x] **9. Injury & Body Condition tab — stats panel + condition history**
...
- [x] **10. Error handling + demo seed script**
